...
q1_s1 = s1.questions.create(  :question_type => "Multiple Choice", 
                       :content => "1. How many shoes do you have?",
                       :no_options => 3,
                       :options_selected => "Just One",
                       :required => true)

q2_s1 = s1.questions.create(  :question_type => "Multiple Choice", 
                       :content => "2. Select all the designers you have clothes by?",
                       :no_options => 3,
                       :options_selected => "Multiple",
                       :required => true)

q3_s1 = s1.questions.create(:question_type => "Multiple Choice", 
                       :content => "3. Number of sequins on dress?",
                       :no_options => 2,
                       :options_selected => "Just One",
                       :required => false)

puts "Creating choices for survey 1, question 1"
puts "******************************"
...
puts "******************************"
q1_s2 = s2.questions.create(  :question_type => "Multiple Choice", 
                       :content => "1. How many animals do you have?",
                       :no_options => 2,
                       :options_selected => "Just One",
                       :required => true)

q2_s2 = s2.questions.create(  :question_type => "Multiple Choice", 
                       :content => "2. What pets do you have?",
                       :no_options => 3,
                       :options_selected => "Multiple",
                       :required => true)

q3_s2 = s2.questions.create(:question_type => "Multiple Choice", 
                       :content => "3. Favourite animal?",
                       :no_options => 3,
                       :options_selected => "Just One",
                       :required => true)
...
puts "******************************"
q1_s3 = s3.questions.create(  :question_type => "Multiple Choice", 
                       :content => "1. Favourite subject?",
                       :no_options => 4,
                       :options_selected => "Multiple",
                       :required => true)

q2_s3 = s3.questions.create(  :question_type => "Multiple Choice", 
                       :content => "2. School Ranking?",
                       :no_options => 3,
                       :options_selected => "Just One",
                       :required => true)

q3_s3 = s3.questions.create( :question_type => "Multiple Choice", 
                       :content => "3. Number of teachers?",
                       :no_options => 3,
                       :options_selected => "Just One",
                       :required => true)

puts "Creating choices for survey 3, question 3"
puts "******************************"
q1_s3.choices.create!(option: "Maths")
q1_s3.choices.create!(option: "Science")
q1_s3.choices.create!(option: "Drama")
q1_s3.choices.create!(option: "Music")

puts "Creating choices for survey 3, question 3"
puts "******************************"
q2_s3.choices.create!(option: "1")
q2_s3.choices.create!(option: "2")
q2_s3.choices.create!(option: "3 or below")

puts "Creating choices for survey 3, question 3"
puts "******************************"
q3_s3.choices.create!(option: "10")
q3_s3.choices.create!(option: "15")
q3_s3.choices.create!(option: "20")